...
public class Encrypter {
     public String[] encryptPassword(String password) {
            String extrasalt="xtufczvgiuhbj";
            String extrasalt2= Long.toString(System.currentTimeMillis());
            String[] output = new String[2];
            try {
                  output[0] = generateStrongPasswordHash(extrasalt + password + extrasalt2);
                  output[1] = extrasalt2;
      ...
      public boolean checkPassword(String password,String salt, String hash)  {
            String extrasalt="xtufczvgiuhbj";
            try {
                  if (validatePassword(extrasalt + password + salt, hash)) {
                        return true;
                  }
            }catch(NoSuchAlgorithmException | InvalidKeySpecException e){
                  e.printStackTrace();
